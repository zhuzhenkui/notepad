package com.shengdan.ui_lib.utils;
...
public class StatusBarUtil {
    ...
    public static final int DEFAULT_STATUS_BAR_ALPHA_60 = 60;
    ...
    public static void setTranslucent(Activity activity) {
        setTranslucent(activity, DEFAULT_STATUS_BAR_ALPHA_60);
    }
    ...
    /**
     * 设置透明 与setTransparentForWindow 配套使用
     */
